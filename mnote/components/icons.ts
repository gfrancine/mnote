    ...
    <svg viewBox="0 0 544 544" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="folder-open-outline-svgrepo-com" transform="translate(16 16)">
        ...
        <g clip-path="url(#mask_1)">
          <path d="M0 112L0 40C0 17.9086 17.9086 0 40 0L115.89 0C123.788 0.000198364 131.509 2.33844 138.08 6.72L165.92 25.28C172.491 29.6616 180.212 31.9998 188.11 32L344 32C366.091 32 384 49.9086 384 72L384 112"
            class="${strokeClass}" transform="translate(64 80)" id="Shape" fill="none" fill-rule="evenodd" stroke-width="32" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M447.902 34.55L431.682 200C431.682 222.064 413.816 239.961 391.752 240L56.2519 240C34.1878 239.961 16.3218 222.064 16.3219 200L0.101862 34.55C-0.609785 25.648 2.43088 16.8536 8.48899 10.2922C14.5471 3.73085 23.0714 -0.000488281 32.0019 0L416.102 0C425.015 0.027359 433.513 3.77081 439.549 10.3289C445.585 16.8869 448.612 25.6653 447.902 34.55L447.902 34.55Z"
            class="${strokeClass}" transform="translate(31.998047 192)" id="Shape" fill="none" fill-rule="evenodd" stroke-width="32" stroke-linecap="round" stroke-linejoin="round" />
        </g>
      </g>
    </svg>
  `),
