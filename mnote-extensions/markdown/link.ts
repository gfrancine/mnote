// https://github.com/Saul-Mirone/milkdown/blob/%40milkdown/vue%405.5.0/packages/preset-commonmark/src/mark/link.ts
// changes: added target="_" dom attribute
    ...
    schema: () => ({
      ...
      toDOM: (mark) => [
        "a",
        {
          ...mark.attrs,
          target: "_blank",
          class: utils.getClassName(mark.attrs, id),
        },
      ],
      parseMarkdown: {
        ...
        (state, match, start, end) => {
          ...
          if (okay) {
            ...
            tr.replaceWith(
              ...
              ctx.get(schemaCtx).text(content)
            ).addMark(
              start,
